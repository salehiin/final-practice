...
const Categories = () => {
    const [book] = useBook();
    const classic = book.filter(item => item.genre === 'Classic');
    const fantasy = book.filter(item => item.genre === 'Fantasy');
    const fiction = book.filter(item => item.genre === 'Fiction');
    const non_fiction = book.filter(item => item.genre === 'Non-Fiction');
